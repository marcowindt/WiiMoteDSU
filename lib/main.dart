        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                DpadArrow(Icons.arrow_back, "D_LEFT", false, buttonDown, buttonUp),
                Padding(padding: EdgeInsets.symmetric(vertical: 0.0, horizontal: 25.0),),
                DpadArrow(Icons.arrow_forward, "D_RIGHT", false, buttonDown, buttonUp),
              ],
            ),
            DpadArrow(Icons.arrow_downward, "D_DOWN", true, buttonDown, buttonUp),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                PadRoundButton(Icons.remove, "MINUS", 30.0, 30.0, buttonDown, buttonUp),
                PadRoundButton(Icons.home, "HOME", 30.0, 30.0, buttonDown, buttonUp),
                PadRoundButton(Icons.add, "PLUS", 30.0, 30.0, buttonDown, buttonUp),
              ],
            ),
            SizedBox(height: 50.0,),
